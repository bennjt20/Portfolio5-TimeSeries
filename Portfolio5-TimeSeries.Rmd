...
After creating my final visualization, then attempting to knit the file, R gave me repeated error messages here, so I removed this command and tried to knit again. Even after removing these commands, error messages resulted when knitting the plots. This was frustrating because I actually produced the graphs, they just would not knit. Therefore, I am keeping the code below for the sake of showing my work.
...
When I try to knit, I get an error: 
